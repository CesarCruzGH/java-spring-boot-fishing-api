    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .hasRole("ADMIN")
                        .requestMatchers(HttpMethod.POST, "/api/v1/peces")
                        .hasRole("ADMIN")
                        .requestMatchers("/actuator/metrics", "/actuator/scheduledtasks")
                        .hasRole("ADMIN")
                        .requestMatchers("/h2-console/**").hasRole("ADMIN")
                        // Públicos → permitAll
                        .requestMatchers("/api/v1/peces/**")
                        .permitAll()
                        .requestMatchers("/api/v1/zonas/**")
                        .permitAll()
                        .requestMatchers("/api/v1/regulaciones/**")
                        .permitAll()
                        .requestMatchers("/api/v1/periodos-veda/**")
                        .permitAll()
                        .requestMatchers("/api/v1/ingestion/health")
                        .permitAll()
